...
export function goToAnsweredQuestions(majorId) {
  return push(ROUTES.QUESTIONS(majorId));
}

export function goToPendingQuestions(majorId) {
  return push(ROUTES.PENDING_QUESTIONS(majorId));
}
